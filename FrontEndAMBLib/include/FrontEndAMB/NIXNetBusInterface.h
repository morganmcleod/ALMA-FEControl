#ifndef _NIXNETBUSINTERFACE_H_
#define _NIXNETBUSINTERFACE_H_
/*******************************************************************************
...
/************************************************************************
 * class NIXNetBusInterface partially implements the command and monitor 
 * protocol in terms of the NI-NI-XNET driver for Windows and using 
...
class NIXNetBusInterface : public CANBusInterface {
public:
    NIXNetBusInterface() {};

    virtual ~NIXNetBusInterface() {};
