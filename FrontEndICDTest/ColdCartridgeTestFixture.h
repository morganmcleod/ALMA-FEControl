...
#define INSTANTIATE_COLDCART_SUITE(CLASS) \
    ...
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB1_LNA_ST1_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB1_LNA_ST2_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB1_LNA_ST3_DRAIN_CURRENT); \
    ...
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB2_LNA_ST1_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB2_LNA_ST2_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL0_SB2_LNA_ST3_DRAIN_CURRENT); \
    ...
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB1_LNA_ST1_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB1_LNA_ST2_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB1_LNA_ST3_DRAIN_CURRENT); \
    ...
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB2_LNA_ST1_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB2_LNA_ST2_DRAIN_CURRENT); \
    CPPUNIT_TEST(testSET_CARTRIDGE_POL1_SB2_LNA_ST3_DRAIN_CURRENT); \
...
public:
    ...
    void testSET_CARTRIDGE_POL0_SB1_LNA_ST1_DRAIN_CURRENT();
    void testSET_CARTRIDGE_POL0_SB1_LNA_ST2_DRAIN_CURRENT();
    void testSET_CARTRIDGE_POL0_SB1_LNA_ST3_DRAIN_CURRENT();
    void testSET_CARTRIDGE_POL0_SB2_LNA_ST1_DRAIN_CURRENT();
    void testSET_CARTRIDGE_POL0_SB2_LNA_ST2_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL0_SB2_LNA_ST3_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB1_LNA_ST1_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB1_LNA_ST2_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB1_LNA_ST3_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB2_LNA_ST1_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB2_LNA_ST2_DRAIN_CURRENT();
	void testSET_CARTRIDGE_POL1_SB2_LNA_ST3_DRAIN_CURRENT();
