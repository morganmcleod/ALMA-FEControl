...
class Band9CCATestFixture : public ColdCartridgeTestFixture {
public:
    Band9CCATestFixture()
      : ColdCartridgeTestFixture(9, "Band9CCATestFixture")
        {}
protected:
...
private:
    INSTANTIATE_COLDCART_SUITE(Band9CCATestFixture)
};

class Band9WCATestFixture : public WCATestFixture {
public:
    Band9WCATestFixture()
      : WCATestFixture(9, "Band9WCATestFixture")
        {}
private:
    INSTANTIATE_WCA_SUITE(Band9WCATestFixture)
};
